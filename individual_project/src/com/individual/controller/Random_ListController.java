...
@WebServlet("/Random")
public class Random_ListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<imgDTO> list = sv.getImgPath_Random(page,result);
		...
		req.getRequestDispatcher("/WEB-INF/view/board/random.jsp").forward(req, resp);
	}
}
